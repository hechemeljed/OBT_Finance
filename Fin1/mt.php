				...
				<div class="container">
					<div class="row">
						...
						<div class="8u skel-cell-mainContent" id="content">
								<article id="main">
									<br>							
									 <form id="f2" name="f2" method ="post" action="calculmt.php"> 
    			<table width="50%" border="0" cellspacing="0">
  <tr>
    <td>Code ISIN</td>
    <td><input id="isin" name="isin" value="TN000" tabindex="1" type="text"> </td>
  </tr>
  <tr><td><p></p></td><td><p></p></td></tr>
  <tr>
    <td>Quantité</td>
    <td><input id="quantite" name="quantite" placeholder="0" tabindex="1" type="text"></td>
  </tr>
  <tr><td><p></p></td><td><p></p></td></tr>
  <tr>
    <td>Cours</td>
    <td><input id="cours" name="cours" placeholder="%" tabindex="1" type="text"></td>
  </tr>
  <tr><td><p></p></td><td><p></p></td></tr>
  <tr>
    <td>Séance</td>
    <td><input id="seance" name="seance" placeholder="" required="" tabindex="1" type="Date"></td>
  </tr>
</table>

			
            <div align="left"><input class="buttom" name="submit" id="submit" tabindex="5" value="Calculer" type="submit">
